...
function makeStatement($data) {
   ...
   switch($t) {
      ...
      case "animals_all":
         return makeQuery($c, "SELECT * FROM `animal_data`", $p);
      case "locations_all":
         return makeQuery($c, "SELECT * FROM `location_data`", $p);

      case "user_by_id":
         //return makeQuery($c, "SELECT * FROM `user_data` WHERE `id` = ?", $p);
         return makeQuery($c, "SELECT `id`,`name`,`email`,`img`,`username` FROM `user_data` WHERE `id` = ?", $p);
      case "animal_by_id":
         return makeQuery($c, "SELECT * FROM `animal_data` WHERE `id` = ?", $p);
      case "location_by_id":
         return makeQuery($c, "SELECT * FROM `location_data` WHERE `id` = ?", $p);

      case "animals_by_user_id":
         return makeQuery($c, "SELECT * FROM `animal_data` WHERE `user_id` = ?", $p);
      case "locations_by_animal_id":
         return makeQuery($c, "SELECT * FROM `location_data` WHERE `animal_id` = ?", $p);
...
"SELECT * FROM animal_data WHERE user_id = ?",
*/
